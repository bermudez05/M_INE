# Juego de la vida - NB (Python - processig 3)
...
# - patrones ingresados: para manualmente ingresar patrones se debe pausar el juego - con las teclas p o P- y con el cursor seleccionar los espacios deseados
